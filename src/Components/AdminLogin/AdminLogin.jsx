                  ...
                  <input
                    ...
                    className={
                      EmailError || (error && error.email)
                        ? "bg-gray-50 border border-red-600 text-gray-900 sm:text-xs rounded-lg focus:ring-primary-600 focus:border-red-800 block w-full p-2.5 dark:border-red-700 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        : "bg-gray-50 border border-gray-300 text-gray-900 sm:text-xs rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    }
