...
function EditModal({ setModalIsOpen,setModalIsOpenToFalse ,action ,showemail ,userdata ,setUsersData}) {
  ...
  const HandleSubmit = (e) => {
    ...
    if((!usernameError&&(!phoneNumberError)&&!confirmPasswordError&&!passwordError)&&((userdata==false && action =="Edit Details"))){
    ...
    }else if((!usernameError&&(!phoneNumberError)&&!confirmPasswordError&&!passwordError &&!EmailError)&&(userdata!=false)){
      const data={
        username:username,
        email:Email,
        password:password,
      ...
      axios.put(`${base_url}api/users/edit_user/${userdata.id}/`,data)
      .then((response) => {
      ...
      if (
        ...
        !passwordError &&
        !phoneNumberError &&
        !confirmPasswordError&&Email.trim()&&username.trim()&&password.trim()&&confirmPassword.trim()&&phone_number.trim()
      ) {
        ...
        ).then((response) => {setModalIsOpenToFalse()
          setTimeout(() => {
